...
class NotificationHelper {
  ...
  static Future<void> initialize(
    ...
    FirebaseMessaging.onMessageOpenedApp.listen((RemoteMessage message) {
      ...
      // Get.to(() => HomeScreen(), arguments: 2);
      // Get.find<HomeController>().currentIndex.value=1;
      // Navigator.of(OneContextcontext).pushReplacementNamed(Routes.HOME);
// OneContext().pushReplacementNamed(Routes.HOME);



      // Get.to(Home(cIndex:1));
      // }
    });
  }
...
//     'com.ajilpay.merchant/notif_on_kill');
//
